...
export const AddJob = ({ open, setOpen, taskId, taskName }: AddJobProps) => {
  ...
  const onSubmit: FormEventHandler = async (event) => {
    ...
    await contract.submitJob(data.description, taskId);
  }
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                            Submit your work on task <span className='bg-gray-100 p-1'>{taskName}</span>.
                          </p>
                          <div className='mt-4 flex flex-col'>
                            <label className="text-sm mt-3 mb-1" htmlFor="description">Job Description:</label>
